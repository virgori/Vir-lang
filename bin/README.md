# Vir Compiler Official Native Binaries (v2.9.0)

The active macOS Apple Silicon compiler (`bin/virc`) is the self-hosted Vir Compiler `v2.9.0`, featuring unified Virgex/Regex pattern infrastructure and canonical dotted module paths. Other target-specific binaries remain at their independently published versions until rebuilt for those targets.
...
| :--- | :--- | :--- | :--- | :--- |
| **macOS Apple Silicon (active v2.9.0)** | `virc` | 2.1 MB | Mach-O 64-bit arm64 | `7c957b15c77d2cfe4d5cbf4aeb40fa110225f64969913e95c896e1c75ee35119` |
| **macOS Apple Silicon (archive)** | `virc-macos-arm64` | 2.0 MB | Mach-O 64-bit arm64 | `bd09638d33312a0c1f393df339601ec47478106350bb2c7ff59234be45300f87` |
