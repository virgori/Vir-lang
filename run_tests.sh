...
# Contract/release-gate spelling: `all` is an alias for the exhaustive suite.
if [ "$MODE" = "all" ]; then
    MODE="full"
fi
...
if [[ "$MODE" =~ ^[0-9]+$ ]]; then
    ...
    echo "Cách dùng: $0 [min|full|all|<1..31>]"
    exit 1
fi
...
run_group_3() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 3 "tests/strict_v2/package_toposort_cycle_e2e.vri"
    else
        run_test_in_group 3 "tests/bootstrap_codegen/cg_include_basic.vri"
        run_test_in_group 3 "tests/bootstrap_codegen/cg_include_nested.vri"
        run_test_in_group 3 "tests/test_expose.vri"
...
run_group_4() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 4 "tests/strict_v2/float_int_cast_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_variable_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_call_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_spill_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_store_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_overflow_trap_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_int_cast_infinity_trap_e2e.vri"
        run_test_in_group 4 "tests/strict_v2/float_i8_cast_range_trap_e2e.vri"
...
run_group_10() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 10 "tests/strict_v2/power_no_space_e2e.vri"
        run_test_in_group 10 "tests/strict_v2/power_negative_e2e.vri"
        run_test_in_group 10 "tests/strict_v2/power_edge_cases_e2e.vri"
        run_test_in_group 10 "tests/strict_v2/power_missing_exponent_rejected.vri"
        run_test_in_group 10 "tests/strict_v2/power_missing_base_rejected.vri"
        run_test_in_group 10 "tests/strict_v2/power_double_operator_rejected.vri"
        run_test_in_group 10 "tests/strict_v2/power_unary_minus_missing_operand_rejected.vri"
        run_test_in_group 10 "tests/strict_v2/power_negative_const_e2e.vri"
    else
        run_test_in_group 10 "tests/test_adv_002_overflow.vri"
        run_test_in_group 10 "tests/test_adv_004_bitwise.vri"
        run_test_in_group 10 "tests/test_adv_005_shift.vri"
...
run_group_13() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 13 "tests/test_erx.vri"
        run_test_in_group 13 "tests/strict_v2/error_function_cleanup_e2e.vri"
        run_test_in_group 13 "tests/strict_v2/error_ensure_early_return_e2e.vri"
        run_test_in_group 13 "tests/strict_v2/error_resume_revert_saga_e2e.vri"
        run_test_in_group 13 "tests/strict_v2/error_timeout_zero_e2e.vri"
        run_test_in_group 13 "tests/strict_v2/error_callee_throw_caught_e2e.vri"
        run_test_in_group 13 "tests/strict_v2/error_throw_non_int_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_erx_outside_cleanup_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_resume_outside_revert_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_try_without_revert_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_cleanup_colon_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_try_end_dot_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_isolate_atomic_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_duplicate_ensure_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_duplicate_try_option_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_isolate_undeclared_rejected.vri"
        run_test_in_group 13 "tests/strict_v2/error_emit_untyped_rejected.vri"
...
run_group_14() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 14 "tests/strict_v2/param_in_type_mismatch_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_group_comma_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_out_early_return_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_out_throw_path_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_out_then_ref_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_out_forwarding_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_ref_immutable_field_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_overlapping_field_args_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_distinct_fields_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_method_ref_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_method_out_e2e.vri"
        run_test_in_group 14 "tests/strict_v2/param_method_ref_temporary_rejected.vri"
        run_test_in_group 14 "tests/strict_v2/param_ufcs_ref_e2e.vri"
        run_test_in_group 14 "tests/test_4param_global.vri"
        run_test_in_group 14 "tests/test_4param_rec.vri"
        run_test_in_group 14 "tests/test_adv_014_many_params.vri"
...
run_group_16() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 16 "tests/strict_v2/mold_zero_width_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_width_overflow_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_negative_width_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_missing_base_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_invalid_base_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_missing_width_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_missing_separator_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_missing_end_dot_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/mold_missing_end_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/register_invalid_range_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/register_range_overflow_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/register_negative_bit_rejected.vri"
        run_test_in_group 16 "tests/strict_v2/register_value_too_large_rejected.vri"
...
run_group_20() {
    ...
    echo "──────────────────────────────────────────────────────────────────────────"
    if [ "$MODE" = "min" ]; then
        run_test_in_group 20 "tests/strict_v2/dict_int_update_e2e.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_dict_duplicate_keys.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_dict_key_edges.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_dict_string_value_equality.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_dict_growth_edge.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_map_filter.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/cg_map_filter_edges.vri"
        run_test_in_group 20 "tests/bootstrap_codegen/dict_import/main.vri"
...
run_group_27() {
    ...
    if [ "$MODE" = "min" ]; then
        ...
        run_test_in_group 27 "tests/strict_v2/alloc_spill_pressure_e2e.vri"
    else
        run_test_in_group 27 "tests/test_intrinsics.vri"
        run_test_in_group 27 "tests/test_native_read_u8.vri"
        run_test_in_group 27 "tests/test_rw64.vri"
