...
const char* q_opcode_name(q_opcode_t op)
{
    switch (op) {
        ...
        /* Network */
        case Q_NET_LISTEN:   return "Q_NET_LISTEN";
        case Q_NET_ACCEPT:   return "Q_NET_ACCEPT";
        case Q_NET_RECV_STR: return "Q_NET_RECV_STR";
        case Q_NET_SEND_STR: return "Q_NET_SEND_STR";
        case Q_NET_CLOSE:    return "Q_NET_CLOSE";
        case Q_NET_SEND_ALL: return "Q_NET_SEND_ALL";
        case Q_NET_SET_NODELAY: return "Q_NET_SET_NODELAY";
        /* New string ops */
        case Q_STR_FIND:     return "Q_STR_FIND";
        case Q_STR_SLICE:    return "Q_STR_SLICE";
        case Q_STR_STARTS:   return "Q_STR_STARTS";
        case Q_STR_CONTAINS: return "Q_STR_CONTAINS";
        case Q_STR_SPLIT:    return "Q_STR_SPLIT";
        case Q_STR_UPPER:    return "Q_STR_UPPER";
        case Q_STR_LOWER:    return "Q_STR_LOWER";
        case Q_STR_REPLACE:  return "Q_STR_REPLACE";
        case Q_STR_TRIM:     return "Q_STR_TRIM";
        case Q_STR_ALLOC:    return "Q_STR_ALLOC";
        case Q_SPRINTF:      return "Q_SPRINTF";
        /* Type conversion */
        case Q_NOT:          return "Q_NOT";
        case Q_I_TO_F:       return "Q_I_TO_F";
        case Q_F_TO_I:       return "Q_F_TO_I";
        case Q_F_TO_STR:     return "Q_F_TO_STR";
        case Q_STR_TO_F:     return "Q_STR_TO_F";
        /* Syscall/OS */
        case Q_TIME:         return "Q_TIME";
        case Q_ENV_GET:      return "Q_ENV_GET";
        case Q_SLEEP:        return "Q_SLEEP";
        /* SIMD */
        case Q_VLOAD:        return "Q_VLOAD";
        case Q_VSTORE:       return "Q_VSTORE";
        case Q_VADD:         return "Q_VADD";
        case Q_VSUB:         return "Q_VSUB";
        case Q_VMUL:         return "Q_VMUL";
        case Q_VFMA:         return "Q_VFMA";
        case Q_VDIV:         return "Q_VDIV";
        case Q_VMIN:         return "Q_VMIN";
        case Q_VMAX:         return "Q_VMAX";
        case Q_VREDUCE:      return "Q_VREDUCE";
        case Q_VSPLAT:       return "Q_VSPLAT";
        case Q_VPERM:        return "Q_VPERM";
        /* Tasks */
        case Q_TASK_SPAWN:   return "Q_TASK_SPAWN";
        case Q_TASK_YIELD:   return "Q_TASK_YIELD";
        case Q_TASK_WAIT:    return "Q_TASK_WAIT";
